...
\begin{block}{Pro Tip}
Add a pre-commit hook to \textbf{automatically block} large files before committing.
\end{block}
\end{frame}
...
\textbf{Prevention:} add a pre-commit hook to block large files before committing.
\end{frame}
